...
public abstract class AbstractController {
    ...
    @ExceptionHandler(UnexpectedOperationException.class)
    public ResponseEntity<Map<String, String>> unexpectedOperationExceptionHandler(UnexpectedOperationException e) {
        getLogger().warn("Handling unexpected operation exception", e);
        Map<String, String> response = new HashMap<>();
        response.put("status", "error");
        response.put("message", e.getMessage());
